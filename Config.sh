...
WRITE_GALAXY_TREE            # Writes galaxy merger trees of specified root mass and redshift
REINDEX                      # Reindexes galaxies with ascending depth first ID in each merger tree
#ROCKSTAR_IDS                 # If enabled all IDS are incremented by -1 to match rockstar halo IDs
#
####################################################################################################
